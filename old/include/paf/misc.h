...
namespace paf {
	...
	public:
		...
		{
			reg3 &= 0xF3;
			interpolatorValuesNum = 0;
		}

		virtual ~Timer();

		SceVoid Init(SceFloat32 time, SceInt32 interpolatorType, SceInt32 reg1Val = 0, SceByte reg0Val = 0xFF, SceFloat32 *interpolatorValues = SCE_NULL);
	...
	private:
		...
		SceChar8 unk_00[0x0C];
		SceUInt32 reg0 : 8;
		SceUInt32 reg1 : 4;
		SceUInt32 state : 4;
		SceUInt32 reg3 : 8;
		SceUInt32 interpolatorType : 4;
		SceUInt32 interpolatorValuesNum : 4;
		SceFloat32 *interpolatorValues;
		SceInt32 unk_18;
	};
