		...
		public:
			...
			public:
				...
				LoadOption()
				{
					...
					unk_68 = true;
					resize_type = image::ImageResizeType_NearestNeighbor;
					read_size = 0;
					read_offset = 0;
					direct_load = false;
					rotate_type = image::ImageRotateType_None;
					flip_type = image::ImageFlipType_None;
				...
				*/
				...
				char unk_10[0x58];
				bool unk_68;
				image::ImageResizeType resize_type;
				size_t read_size;
				size_t read_offset;
				bool direct_load;
				image::ImageRotateType rotate_type;
				image::ImageFlipType flip_type;
				ImageOrder image_order;
				int32_t unk_88;
				int32_t unk_8C;
				int32_t unk_90;
